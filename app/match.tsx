...
const makeStyles = (theme: Theme) => StyleSheet.create({
  ...
  teamName: { color: theme.colors.text, fontFamily: theme.fonts.body, fontSize: theme.font.small, fontWeight: '600', flexShrink: 1 },
  teamNameRight: { textAlign: 'right' },
  score: { color: theme.colors.text, fontFamily: theme.fonts.numeric, fontSize: 30, fontWeight: '900', paddingHorizontal: theme.spacing(1.5) },
  sectionTitle: { color: theme.colors.textMuted, fontFamily: theme.fonts.body, fontSize: theme.font.small, textTransform: 'uppercase', letterSpacing: 1, marginTop: theme.spacing(1) },
